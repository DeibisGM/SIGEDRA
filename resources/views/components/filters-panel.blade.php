                ...
                <div class="mt-2">
                    ...
                    <div class="relative max-w-sm">
                        <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                            <i class="ph ph-calendar w-4 h-4 text-gray-500 dark:text-gray-400"></i>
                        </div>
                        <input id="start_date" type="text" class="custom-datepicker bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sigedra-primary focus:border-sigedra-primary block w-full ps-10 p-2.5" placeholder="Seleccionar fecha" autocomplete="off" wire:model.defer="startDate">
                    </div>
                </div>
                <div class="mt-2">
                    ...
                    <div class="relative max-w-sm">
                        ...
                        <input id="end_date" type="text" class="custom-datepicker bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sigedra-primary focus:border-sigedra-primary block w-full ps-10 p-2.5" placeholder="Seleccionar fecha" autocomplete="off" wire:model.defer="endDate">
                    </div>
                </div>
            </div>
