<div wire:init="loadEstudiantes">
    ...
    <div class="space-y-4 mb-4">
        ...
        <div class="relative w-full">
            ...
            <input wire:model.lazy="search" id="search" type="text" class="py-2 px-4 ps-11 block w-full bg-white border-sigedra-border rounded-lg text-sm placeholder-sigedra-text-light focus:border-sigedra-primary focus:ring-sigedra-primary" placeholder="Buscar por cédula, nombre, etc...">
    ...
    @if ($isReady)
        {{-- Contenedor de la tabla y el indicador de carga --}}
        <div class="relative" wire:loading.class.delay="opacity-50 pointer-events-none" wire:target="search, anio_academico_id, grado_id">
            {{-- Indicador de Carga --}}
            <div wire:loading.flex.delay wire:target="search, anio_academico_id, grado_id" class="absolute inset-0 bg-white bg-opacity-75 flex items-center justify-center w-full p-4 z-10">
                <div class="flex items-center">
                    <i class="ph ph-spinner ph-spin text-3xl text-sigedra-primary"></i>
                    <span class="ms-3 text-lg text-sigedra-text-medium font-semibold">Cargando...</span>
                </div>
            </div>
