...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row justify-between md:items-center gap-4">
        <div>
            ...
            <div class="mt-2 text-sigedra-text-medium">
                <p class="font-bold text-lg text-sigedra-text-dark">Curso: <span class="font-semibold">Matemáticas Avanzadas</span></p>
                <p class="text-base">Profesor Asignado - 7-1 - 2025 - Lunes 9-10am / Martes 11-12pm</p>
            </div>
        </div>
        <div class="relative">
            <input type="text" class="py-2.5 px-4 w-48 bg-white border border-sigedra-border rounded-lg text-base text-sigedra-text-dark focus:border-sigedra-primary focus:ring-sigedra-primary" value="10/09/2025">
    ...
    <div class="flex flex-col md:flex-row gap-4 justify-between items-center">
        ...
        <div class="flex gap-3">
            <x-buttons.secondary>Actualizar</x-buttons.secondary>
